...
filesizes = []
totalsizes = 0
for img_path, target_class in instances:
    filesize = os.path.getsize(img_path)
    filesizes.append((img_path, filesize))
    totalsizes += filesize
...
for x in filesizes:
    randomsizes.append(x)
    total_randomsizes += x[1]
    if total_randomsizes > totalsizes/3.3:
        break

# print((randomsizes))
print(len(randomsizes))
print(total_randomsizes)
