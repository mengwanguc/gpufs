...
for batch_size in ${batch_sizes[@]}; do
    ...
    cgexec -g memory:$group_name python main-measure-time-emulator.py --use-async True --skip-epochs 0 --emulator-version=1 -j 4 --epoch 1 --workers $n_workers --gpu-count 1 --gpu-type $gpu_type -a $model --batch-size $batch_size --profile-batches -1 $data_path
