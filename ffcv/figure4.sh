...
for limit in ${limits[@]}; do
    ...
    cgexec -g memory:$group_name python main-original-ffcv-v2-cuda-emulatorv0-cpu.py  --epoch 2 --workers $n_workers --gpu-type=$gpu_type --gpu-count=$gpu_count --arch=$model  ~/data/imagenette2 &> outputsfig4/output$limit.txt
