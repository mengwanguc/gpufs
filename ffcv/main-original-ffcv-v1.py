...
parser.add_argument('-t', '--train-file', default='/home/cc/ffcv-imagenet/train_500_0_50_90.ffcv',
                    help='path to FFCV train dataset')
parser.add_argument('-v', '--val-file', default='/home/cc/ffcv-imagenet/val_500_0.50_90.ffcv',
                    help='path to FFCV val dataset')
parser.add_argument('-d', '--data-dir', metavar='DIR', default='/home/cc/data/test-accuracy/imagenette2',
