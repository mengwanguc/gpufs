...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    output_filename = "{}/{}-batch{}.csv".format("rtx6000", args.arch, args.batch_size)
    if not os.path.exists("rtx6000"):
        os.makedirs("rtx6000")
    with open(output_filename, 'w') as f:
        f.write("{}\t{}\n".format("preprocess_time", "gpu_time"))
        for i in range(len(data_time_list)):
            f.write("{:.9f}\t{:.9f}\n".format(data_time_list[i], gpu_time_list[i]))
