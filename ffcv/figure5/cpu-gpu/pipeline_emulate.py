...
"""
    ...
    def _run_once(self):
        ...
        try:
            ...
            # with open("/home/cc/gpufs/ffcv/figure5/cpu/preproces-cpu-time-emulate.txt", 'a') as f:
                # f.write("{:.9f}\n".format(end_cpu))
            start_gpu = time.time()
            self._run_gpu()
            end_gpu = time.time() - start_gpu
            with open("/home/cc/gpufs/ffcv/figure5/cpu-gpu/preproces-gpu-time-emulate.txt", 'a') as f:
                f.write("{:.9f}\n".format(end_gpu))
