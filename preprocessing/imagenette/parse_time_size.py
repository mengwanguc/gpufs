...
plt.scatter(filesizes, training_decoding_times, label="Decoding", s=1)
plt.scatter(after_decoding_sizes, time_random_resized_crop_sizes, label="RandomResizedCrop", s=1)
...
plt.yticks(yticks)
plt.xlabel("Size before preprocessing step(KB)")
plt.ylabel("Proprocessing time (ms)")
plt.title("Preprocessing time vs filesize before preprocessing step")
