...
plt.plot(epoch_range, batch_top1_top5, label = 'no_grouping_bsize2', color="blue", linewidth=1)
# plt.plot(epoch_range, batch_top1_top5_size4, label = 'grouping_bsize2_gsize2', color="red", linewidth=1)
plt.plot(epoch_range, batch_top1_top5_size2, '--', label = 'rand-perm-grouping_bsize2_gsize2', color="green", linewidth=3)
