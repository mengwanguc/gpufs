    ...
    for annotation in annotations['annotations']:
        ...
        for image in annotations['images']:
            if image_id == image['id']:
                ...
                break 
        # image_path = '/path/to/images/' + annotations['images'][image_id]['file_name']  # Replace with the actual path to the images
        category_id = annotation['category_id']
        bbox = annotation['bbox']
        area = annotation['area']
        iscrowd = annotation['iscrowd']
        
        samples.append((image_path, category_id, image_id, bbox, area, iscrowd))
...
with open(mytar_save_folder + "metadata.txt", 'w') as metadata_writer:
    ...
    for i in range(group_num):
        ...
        for j in range(group_size):
            ...
            image_path, class_id, image_id, bbox, area, iscrowd = instances[idx]
            img_size = os.path.getsize(image_path)
            
            # print("stop")
            # quit()
            
            metadata += '{},{},{},{},{},{},{},{},{},{}\n'.format(j, class_id, offset, img_size, image_path, class_id, image_id, bbox, area, iscrowd)
            offset += img_size
