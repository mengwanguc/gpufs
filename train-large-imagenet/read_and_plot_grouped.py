...
current_title = 'Epoch related Training top 5 Accuracy on Large Imagenet'
...
plt.plot(epoch_range, batch_top1_top5, '-', label = 'no_grouping')
plt.plot(epoch_range, batch_top1_top5_size2, '-.', label = 'grouping')
plt.plot(epoch_range, batch_top1_top5_size4, label = 'sequential-grouping')
...
bat = str(batch_size)
results_dir = ''
sample_file_name = "sequential_" + model+"_"+current_p + "_batch_" + bat +"_epo_"+ ep +".png" 
