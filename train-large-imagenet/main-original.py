...
def save_checkpoint(state, is_best, filename='checkpoint-large-imagenet.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best-large-imagenet.pth.tar')
